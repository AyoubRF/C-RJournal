...
var NzCascaderService = /** @class */ (function () {
    ...
    function (searchValue) {
        ...
        var loopParent = function (node, forceDisabled) {
            ...
            var disabled = forceDisabled || node.disabled;
            path.push(node);
            (/** @type {?} */ (node.children)).forEach(function (sNode) {
                if (!sNode.parent) {
                    sNode.parent = node;
                }
                if (!sNode.isLeaf) {
    ...
    function (columnIndex, value // tslint:disable-line:no-any
        ...
        if (targetColumn) {
            ...
            return (/** @type {?} */ (targetColumn.find(function (o) { return v_1 === _this.getOptionValue(o); })));
        }
        return null;
    };
    /**
