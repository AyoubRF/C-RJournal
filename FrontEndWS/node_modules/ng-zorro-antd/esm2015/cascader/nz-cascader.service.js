...
export class NzCascaderService {
    ...
    prepareSearchOptions(searchValue) {
        ...
        const loopParent = (node, forceDisabled = false) => {
            ...
            const disabled = forceDisabled || node.disabled;
            path.push(node);
            (/** @type {?} */ (node.children)).forEach(sNode => {
                if (!sNode.parent) {
                    sNode.parent = node;
                }
                if (!sNode.isLeaf) {
    ...
    findOptionWithValue(columnIndex, value // tslint:disable-line:no-any
        ...
        if (targetColumn) {
            ...
            return (/** @type {?} */ (targetColumn.find(o => v === this.getOptionValue(o))));
        }
        return null;
    }
    /**
